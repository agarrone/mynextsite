    ...
    <div className="flex min-h-screen justify-center bg-[var(--background)] text-[var(--text-primary)]">
      <main className="flex w-full max-w-[550px] flex-col justify-center px-5 sm:px-4 md:px-6">
        <section className="fade-up flex flex-col gap-5 py-10">
          ...
          <div className="flex flex-col gap-4 text-[16px] text-[var(--text-muted)]">
            <a
              href="mailto:antoningarrone@gmail.com"
            ...
            <a
              href="https://github.com/agarrone"
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 hover:text-[var(--text-primary)] hover:underline"
            >
            ...
            <a
              href="https://x.com/antonin_garrone"
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 hover:text-[var(--text-primary)] hover:underline"
            >
            ...
            <a
              href="https://bsky.app/profile/agarrone.bsky.social"
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 hover:text-[var(--text-primary)] hover:underline"
            >
            ...
            <a
              href="https://mastodon.social/@agarrone"
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 hover:text-[var(--text-primary)] hover:underline"
            >
              <MastodonLineIcon className="h-4 w-4" />
              Mastodon
              <ArrowUpRight className="h-3.5 w-3.5" />
            </a>
          </div>
